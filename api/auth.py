...
def login():
    ...
    try:
        ...
        try:
            ...
            return (
                jsonify({"error": "Invalid login data", "details": err.messages}),
                400,
            )
...
def register():
    ...
    try:
        ...
        try:
            ...
            return (
                jsonify(
                    {"error": "Invalid registration data", "details": err.messages}
                ),
                400,
            )
...
def refresh():
    ...
    try:
        ...
        if not user or not user.is_active:
            logger.warning(
                f"Token refresh attempt for inactive or non-existent user ID: {current_user_id}"
            )
