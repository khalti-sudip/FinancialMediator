    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["source_system"], name="transaction_source__46340e_idx"
                    ),
                    models.Index(
                        fields=["target_system"], name="transaction_target__c8dd35_idx"
                    ),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["system_name"], name="system_conf_system__06c4da_idx"
                    ),
                    models.Index(
                        fields=["system_type"], name="system_conf_system__459942_idx"
                    ),
                    models.Index(
                        fields=["is_active"], name="system_conf_is_acti_ea95db_idx"
                    ),
                ],
            },
        ),
