...
from banking_api.views.auth_views import LoginView, RegisterView, TokenRefreshView, VerifyTokenView
from banking_api.views.kyc_views import KYCViewSet, DematAccountViewSet, PortfolioViewSet
